...
#pragma message "BASELINES=YES"
        //  benchmark_updates<hashtable<key32, 20>>(rc, runs);
        //  -------------benchmark_updates<cg_rtx_index<key32, 5>>(rc, runs);
        #ifdef HASHTABLE
        #pragma message "HASHTABLE=YES"
          benchmark_updates<hashtable<key32, 30>>(rc, runs);
        #else
        #pragma message "GPU_BTREE=YES"
          benchmark_updates<tree<key32, 200>>(rc, runs);
        #endif
...
#pragma message "64 bit version MAIN_32=NO"
       ...
       // benchmark_updates<cg_rtx_index_updates<key64, 20, 0, 50, 150>>(rc, runs);
       // ---> benchmark_updates<tree<key64, 125>>(rc, runs);
       // 
